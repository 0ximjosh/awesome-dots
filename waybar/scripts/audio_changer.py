...
wofi_command = f"echo '{output}' | wofi --show=dmenu --hide-scroll --allow-markup --define=hide_search=true --location=top_right --width=600 --height=120 --style $HOME/.config/wofi/styles.css --xoffset=-60"
